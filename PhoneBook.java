...
public class PhoneBook {
    public static void main(String[] args) {
        ...
        System.out.println("Введите данные для заполнения телефонной книги (формат: Имя НомерТелефона), для просмотра данных введите \"view\", для удаления данных введите \"delete\", для завершения введите 'exit':");
